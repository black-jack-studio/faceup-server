          ...
          >
            <div>
              ...
              <Input
                ...
                className="w-full bg-white/5 border-white/20 rounded-2xl px-4 py-4 !text-white placeholder-white text-lg focus:border-accent-green focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 transition-all"
