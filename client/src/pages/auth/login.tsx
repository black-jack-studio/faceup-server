          ...
          >
            <div>
              ...
              <Input
                ...
                className="w-full bg-white/5 border-white/20 rounded-2xl px-4 py-4 text-white placeholder-white/40 text-lg focus:border-accent-green focus:ring-2 focus:ring-accent-green/20 transition-all"
