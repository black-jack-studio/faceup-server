          ...
          >
            <div>
              ...
              <Input
                ...
                className="w-full bg-white/5 border-white/20 rounded-2xl px-4 py-3 !text-white placeholder-white focus:border-accent-purple focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 transition-all"
