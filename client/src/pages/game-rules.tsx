      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="space-y-8 text-white leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-white">Goal</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-white">How a hand plays out</h3>
              <div className="text-white/80 space-y-2 text-sm leading-relaxed">
                <p>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-white">Your options</h3>
              <div className="text-white/80 space-y-3 text-sm leading-relaxed">
                <p><span className="text-white font-semibold">Hit</span> — take another card.</p>
                <p><span className="text-white font-semibold">Stand</span> — keep your current hand and end your turn.</p>
                <p>
                  <span className="text-white font-semibold">Double Down</span> — double your bet, take exactly
                  one more card, then stand. Only available as your first decision on a hand.
                </p>
                <p>
                  <span className="text-white font-semibold">Split</span> — if your first two cards have the same
                ...
                <p>
                  <span className="text-white font-semibold">Surrender</span> — give up the hand immediately and get
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-white">The dealer's turn</h3>
              <div className="text-white/80 space-y-2 text-sm leading-relaxed">
                <p>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-white">Payouts</h3>
              <div className="text-white/80 space-y-2 text-sm leading-relaxed">
