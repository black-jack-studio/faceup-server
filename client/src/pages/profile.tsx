          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="relative inline-block">
              <Dialog open={isAvatarDialogOpen} onOpenChange={setIsAvatarDialogOpen}>
                ...
                <DialogContent className="bg-ink border border-white/10 max-w-lg max-h-[80vh] overflow-y-auto rounded-3xl [&>button]:absolute [&>button]:-top-12 [&>button]:right-0 [&>button]:bg-white/10 [&>button]:rounded-full [&>button]:p-2">
