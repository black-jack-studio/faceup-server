      ...
      <div className="max-w-md mx-auto">
        ...
        >
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <motion.button
                className="w-full bg-black rounded-xl p-5 border border-white/10 text-center hover:bg-white/5 transition-all h-full"
        ...
        {/* Friends Section - Same Height */}
            <motion.button
              ...
              className="bg-black hover:bg-white/5 rounded-xl p-6 border border-white/10 h-full flex flex-col transition-all cursor-pointer"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
