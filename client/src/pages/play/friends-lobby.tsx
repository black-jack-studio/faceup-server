              ...
              >
                ...
                <div className="flex flex-col items-center gap-6 flex-shrink-0 w-full">
                  ...
                  {(() => {
                    ...
                    // Zero coins beats every other state here (Anatole, 2026-09-03) -- with
                    // nothing to bet, "Waiting for your friend…"/a draggable-but-pointless slider
                    // is just dead UI. Same "GO TO SHOP" swap as Classic's bet screen
                    // (classic.tsx), landing on the same ?section=coins Coin Packs anchor.
