...
function App() {
  ...
  // The whole sound system (audio unlock + app-wide click sound) is shelved for now —
  // see the SOUND_SYSTEM_ENABLED flag in @/lib/sound. Flip that back on and restore this
  // pointerdown/click wiring to bring it back.
