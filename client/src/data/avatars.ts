...
// New 3D girl avatars - Priority order
import newGirlDefaultImg from '@assets/girl_3d_default_1758405678347.png';
import newGirlMediumLightImg from '@assets/girl_3d_medium-light_1758405678347.png';
import newGirlLightImg from '@assets/girl_3d_light_1758405678348.png';
import newGirlMediumImg from '@assets/girl_3d_medium_1758405678348.png';
...
// New 3D old woman avatars
import newOldWomanDefaultImg from '@assets/old_woman_3d_default_1758405995971.png';
import newOldWomanLightImg from '@assets/old_woman_3d_light_1758405995972.png';
import newOldWomanMediumImg from '@assets/old_woman_3d_medium_1758405995972.png';
import newOldWomanMediumDarkImg from '@assets/old_woman_3d_medium-dark_1758405995972.png';
...
export const AVAILABLE_AVATARS: Avatar[] = [
  ...
  // Priority 3D girl avatars - new versions
  {
    id: 'new-girl-3d-default',
    name: 'Girl 3D Default (New)',
    image: newGirlDefaultImg,
    category: '3d'
  },
  {
    id: 'new-girl-3d-medium-light',
    name: 'Girl 3D Medium Light (New)',
    image: newGirlMediumLightImg,
    category: '3d'
  },
  {
    id: 'new-girl-3d-light',
    name: 'Girl 3D Light (New)',
    image: newGirlLightImg,
    category: '3d'
  },
  {
    id: 'new-girl-3d-medium',
    name: 'Girl 3D Medium (New)',
    image: newGirlMediumImg,
    category: '3d'
  },
  {
    id: 'new-girl-3d-medium-dark',
    name: 'Girl 3D Medium Dark (New)',
    image: newGirlMediumDarkImg,
    category: '3d'
  },
  {
    id: 'new-girl-3d-dark',
  ...
  // Priority 3D old woman avatars
  {
    id: 'new-old-woman-3d-default',
    name: 'Old Woman 3D Default (New)',
    image: newOldWomanDefaultImg,
    category: '3d'
  },
  {
    id: 'new-old-woman-3d-light',
    name: 'Old Woman 3D Light (New)',
    image: newOldWomanLightImg,
    category: '3d'
  },
  {
    id: 'new-old-woman-3d-medium',
    name: 'Old Woman 3D Medium (New)',
    image: newOldWomanMediumImg,
    category: '3d'
  },
  {
    id: 'new-old-woman-3d-medium-dark',
    name: 'Old Woman 3D Medium Dark (New)',
    image: newOldWomanMediumDarkImg,
    category: '3d'
  },
  {
    id: 'new-old-woman-3d-dark',
    name: 'Old Woman 3D Dark (New)',
    image: newOldWomanDarkImg,
    category: '3d'
  },
