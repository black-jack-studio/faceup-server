        ...
        {!showBetSelector && (
          <div className="flex flex-col h-screen pt-16 pb-4 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col justify-start min-h-0 px-4">
              ...
              <div className="flex justify-center flex-1 items-start pt-1 pb-2">
                <HandCards
                  cards={dealerHand}
            ...
            <div className="absolute left-0 right-0 z-10 flex items-center justify-between px-2 py-4 mb-4" style={{ top: '41%', transform: 'translateY(-50%)' }}>
