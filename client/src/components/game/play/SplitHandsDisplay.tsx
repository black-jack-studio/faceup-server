      ...
      {splitHands.map((hand, index) => (
        ...
        >
          ...
          <div className="relative mb-2">
            ...
            <motion.div layout="position" transition={{ type: "tween", duration: 0.3, ease: "easeInOut" }} className="flex flex-wrap gap-1.5 justify-center max-w-[150px]">
              <AnimatePresence>
            ...
            {hand.hand.length > 2 && (
              <motion.div layout="position" transition={{ type: "tween", duration: 0.3, ease: "easeInOut" }} className="flex flex-wrap gap-1.5 justify-center mt-2 max-w-[150px]">
                <AnimatePresence>
